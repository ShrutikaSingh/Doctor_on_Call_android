...
public class MainActivity extends AppCompatActivity implements LocationListener {
    ...
    public void aiDiagnose(View view) {
        Intent i = new Intent(this, AiDiagnoseActivity.class);
        startActivity(i);
    }

    public void viewDiseaseSpreadMap(View view) {
        Intent i = new Intent(this, DateSelectorForEpidemicMap.class);
        startActivity(i);
    }
}
